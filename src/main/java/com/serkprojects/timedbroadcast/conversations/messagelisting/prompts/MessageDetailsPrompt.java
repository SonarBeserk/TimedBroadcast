...
package com.serkprojects.timedbroadcast.conversations.messagelisting.prompts;
...
public class MessageDetailsPrompt extends StringPrompt {
    private TimedBroadcast plugin = null;

    public MessageDetailsPrompt(TimedBroadcast plugin) {
        this.plugin = plugin;
    }
